...
export const readme: BioSection[] = [
  {
    ...
    paragraphs: [
      "I'm responsible for our 12-engineer org: focus, priority, output, hiring, and presenting engineering and AI strategy to the board. We don't have product managers, so the \"what\" and the \"why\" sit with engineering alongside the \"how\", and honestly I prefer it that way: I talk to customers, dig into the data, decide what's worth building, then build it. Despite the title, I try to spend most of my time shipping code, roughly 70% of my week, and I am disappointed if I don't ship three to five PRs in a day.",
